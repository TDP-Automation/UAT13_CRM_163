...
''Validar lo adicional en producción Pelao
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución_2").JavaObject("PanelNative$JXPanel").Exist=False
		wait 1
	Wend

'JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución_2").JavaStaticText("Nombre y Dirección de").Click
	...
	Wend
	Dim dir
	dir=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución_2").JavaEdit("Nombre y Dirección de").GetROProperty("text")
	While dir=""
		dir=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución_2").JavaEdit("Nombre y Dirección de").GetROProperty("text")
	Wend
	wait 1
	...
	Select Case str_metodo_entrega
		...
		Case "Delivery"
				...
				wait 1
					...
					Wend
				wait 2
				JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de_2").JavaList("ComboBoxNative$1").Select DataTable("docu_Delivery",dtLocalSheet)
				wait 1
				JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de_2").JavaEdit("TextFieldNative$1").Set DataTable("numDocu_Delivery",dtLocalSheet)
				wait 1
...
'		End If
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Resumen de la orden (Orden").Exist(1) Then
			...
			wait 2
			If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaCheckBox("El cliente firmó.").GetROProperty("enabled")="1" then
